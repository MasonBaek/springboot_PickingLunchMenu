...
--
-- Table structure for table `choicemenu`
--
...
--
-- Dumping data for table `choicemenu`
--

LOCK TABLES `choicemenu` WRITE;
/*!40000 ALTER TABLE `choicemenu` DISABLE KEYS */;
/*!40000 ALTER TABLE `choicemenu` ENABLE KEYS */;
UNLOCK TABLES;
