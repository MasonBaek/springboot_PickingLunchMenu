...
<div class="wraper">
    <div class="header">
        <h1 class="logo" onclick="location.reload()">LUNCH</h1>
        <div id="clock"></div>
...
<%-- 팝업 시작 --%>
    <div class="layer-popup" id="layer-popup">
        <div class="modal-dialog">
            ...
            <button type="button" class="btn-store-choice">식당 선택하기</button>
...
<script>
        ...
        function popUpMenu(storeName){
            ...
            $('.modal-content').html('<img src="./img/'+storeName+'.jpg"/>');
            $('input#storeName').val(storeName);
        }
